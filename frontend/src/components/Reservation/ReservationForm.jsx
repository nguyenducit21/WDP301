...
export default function ReservationForm() {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center", marginBottom: 20 }}>Đặt bàn online</h2>
      <div
        style={{
          display: "flex",
      ...
      >
        {["Điền thông tin", "Chọn bàn", "Chọn món", "Xác nhận"].map(
          (label, idx) => (
            <div
              key={label}
              style={{
      ...
      {step === 2 && (
        <Step2Table form={form} setForm={setForm} next={next} prev={prev} />
      )}
      {step === 3 && (
        <Step3Menu form={form} setForm={setForm} next={next} prev={prev} />
      )}
